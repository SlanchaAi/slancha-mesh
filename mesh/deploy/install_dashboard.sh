...
note: named tunnel "$TUNNEL_NAME" not found.
      One-time provisioning (operator runs these):
        ...
        $CLOUDFLARED tunnel route dns $TUNNEL_NAME evals.laulpogan.com
...
echo
echo "Done. Dashboard should appear at https://evals.laulpogan.com within"
echo "30s. First-boot Cloudflare Universal SSL provisioning can take up"
echo "to 15min — poll evals.laulpogan.com/_stcore/health until 200."
echo
echo "Logs:"
